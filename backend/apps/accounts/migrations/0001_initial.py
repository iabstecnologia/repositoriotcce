    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(blank=True, max_length=300, verbose_name='primeiro nome')),
                ('last_name', models.CharField(blank=True, max_length=300, verbose_name='sobrenome')),
